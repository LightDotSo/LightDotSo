...
<Image className="rounded-md" src="https://assets.light.so/blog/announcements/introducing-light/integrated-tech-stack.png" alt="Introducing Light"  width={1200} height={630} />
