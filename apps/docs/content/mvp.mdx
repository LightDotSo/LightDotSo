...
- **Billing** Billing page on the dashboard is "emulated" as the protocol balance, where nodes keep track of the balance of each user. Right now, escrow is a featureset for the protocol, where users can escrow their assets in the protocol in exchange for fronted services + cross-chain gas fees.
