...
- Shares can be deposited to a protocol operator for yield generaton across chains, and fees will be paid out to the individual LPs (fees will not necessarily accrue to the individual shares)
- Yield generated from the protocol fees can be rebalanced
