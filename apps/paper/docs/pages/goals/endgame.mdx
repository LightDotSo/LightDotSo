...
Light achieves this through a combination of smart contracts, relayers, and programmatic cross-chain execution.
...
3. Users signs one signature to authorize the transaction on the target chain(s)
...
What are some targets to meet for a user to feel like they are interacting with a single chain?

- Minimize the number of clicks + signatues

Users should not have to sign multiple transactions to interact across multiple chains.
