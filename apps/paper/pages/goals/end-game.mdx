...
If the contents of the transaction(s) is financially sensitive, the user would be able to set areference for the transaction(s) to be routed across a network that is most secure, or most private, or most censorship-resistant, etc.
