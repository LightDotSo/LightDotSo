...
Light is an EVM chain abstraction protocol designed to unify the Ethereum ecosystem for dApps, developers, and users.
...
![introduction](https://assets.light.so/paper/introduction.png)
...
::::tip
Light employs EVM chain abstraction to integrate all chains into a single cohesive experience.
::::
...
![architecture](https://assets.light.so/paper/architecture.png)
