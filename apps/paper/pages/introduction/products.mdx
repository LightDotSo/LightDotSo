...
:::tip
We envision to support the long tail of chains through our stack, meaning that the modularization of each layer (which is a key aspect of the Light) is crucial, as an opt-in approach of a different layers enables better chain & developer support.
:::
