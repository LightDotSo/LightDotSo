...
Two features required for chain abstraction that we support out of the box are [state sync](/concepts/keystore-sync) and [signature aggregation](/concepts/signature-aggregation).
