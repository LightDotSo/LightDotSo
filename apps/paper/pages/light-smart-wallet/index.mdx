...
Two features required for chain abstraction that we support out of the box are [state sync](/features/keystore-sync) and [signature aggregation](/features/signature-aggregation).
