...
Here are some things that we make possible:

## Nonce Programmability

In the traditional EOA wallets, nonce is sequential and cannot be programmatically defined.
However, with compatibility with 4337 standard, we can define the nonce programmatically, enabling non-sequential nonce generation.
This leads to better compatibility with cross-chain intents.
