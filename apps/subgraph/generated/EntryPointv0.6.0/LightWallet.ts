...
export class LightWallet extends ethereum.SmartContract {
  ...
  entryPoint(): Address {
    const result = super.call("entryPoint", "entryPoint():(address)", []);

    return result[0].toAddress();
  }

  try_entryPoint(): ethereum.CallResult<Address> {
    const result = super.tryCall("entryPoint", "entryPoint():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  getNonce(): BigInt {
    const result = super.call("getNonce", "getNonce():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getNonce(): ethereum.CallResult<BigInt> {
    const result = super.tryCall("getNonce", "getNonce():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  imageHash(): Bytes {
    const result = super.call("imageHash", "imageHash():(bytes32)", []);

    return result[0].toBytes();
  }

  try_imageHash(): ethereum.CallResult<Bytes> {
    const result = super.tryCall("imageHash", "imageHash():(bytes32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    const value = result.value;
  ...
  proxiableUUID(): Bytes {
    const result = super.call("proxiableUUID", "proxiableUUID():(bytes32)", []);
