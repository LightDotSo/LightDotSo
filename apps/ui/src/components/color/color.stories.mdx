...
<ColorPalette>
  ...
  <ColorItem
    ...
    colors={{
      DEFAULT: "hsl(var(--background-new))",
      weakest: "hsl(var(--background-new-weakest))",
    }}
  />
  <ColorItem
  ...
  <ColorItem
    title="border-new"
    colors={{
      DEFAULT: "hsl(var(--border-new))",
      weak: "hsl(var(--border-new-weak))",
      weaker: "hsl(var(--border-new-weaker))",
      weakest: "hsl(var(--border-new-weakest))",
    }}
  />
  <ColorItem
