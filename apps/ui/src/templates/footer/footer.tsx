...
export const Footer: FC = () => {
  return (
    <footer className="border-t border-border" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 pb-10 md:pb-20 md:pt-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          <FooterSocial />
          <FooterList />
        </div>
        <div className="mt-8 md:mt-12 space-y-6 border-t border-border pt-8 md:flex md:items-center md:justify-between">
