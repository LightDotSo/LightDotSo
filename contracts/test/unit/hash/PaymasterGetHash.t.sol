...
contract PaymasterGetHashUnitTest is BaseTest {
    ...
    /// Tests that the account complies w/ ERC-165
    function test_paymaster_getHash_initCode() public {
        address sender = address(0xF46D20dC61A5f43773Ad172602647f194a69a16d);
        uint256 nonce = 0;
    ...
    /// Tests that the account complies w/ ERC-165
    function test_paymaster_getHash_callData() public {
        address sender = address(0xF46D20dC61A5f43773Ad172602647f194a69a16d);
        uint256 nonce = 0;
    ...
    /// Tests that the account complies w/ ERC-165
    function test_paymaster_getHash_raw() public {
        address sender = address(0xF46D20dC61A5f43773Ad172602647f194a69a16d);
        uint256 nonce = 0;
        bytes memory initCode = hex"";
        bytes memory callData = hex"";
    ...
    /// Tests that the account complies w/ ERC-165
    function test_paymaster_getHash_long() public {
        address sender = address(0xF46D20dC61A5f43773Ad172602647f194a69a16d);
        uint256 nonce = 0;
        bytes memory initCode =
    ...
    /// Tests that the account complies w/ ERC-165
    function test_paymaster_getHash_real() public {
