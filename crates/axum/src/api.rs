...
#[openapi(
    components(
        ...
        schemas(configuration_operation::create::ConfigurationSignatureCreateOwnerParams),
        schemas(configuration_operation::create::ConfigurationSignatureCreateParams),
        schemas(configuration_operation::create::ConfigurationSignatureCreateRequestParams),
