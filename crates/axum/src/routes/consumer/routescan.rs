...
use lightdotso_consumer::topics::routescan::RoutescanConsumer;
...
/// Consumer routescan
///
/// Consumers an routescan for processing.
#[utoipa::path(
        post,
        path = "/consumer/routescan",
        params(
            PostQuery
        ),
        responses(
...
#[autometrics]
pub(crate) async fn v1_consumer_routescan_handler(
    ...
    let consumer = RoutescanConsumer;
    let msg = RoutescanMessage { chain_id: query.chain_id, address: parsed_query_address };
