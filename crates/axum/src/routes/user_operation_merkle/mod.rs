...
pub(crate) use get::{
    __path_v1_user_operation_merkle_get_handler, v1_user_operation_merkle_get_handler,
};
pub(crate) use list::{
    __path_v1_user_operation_merkle_list_handler, v1_user_operation_merkle_list_handler,
};
...
pub(crate) fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/user_operation_merkle/list", get(v1_user_operation_merkle_list_handler))
}
