...
mod tests {
    ...
    fn test_hash_zeroed() {
        ...
        let entry_point = "0x0000000071727De22E5E9d8BAf0edAc6f37da032".parse().unwrap();
        let chain_id = 1337;
    ...
    fn test_hash() {
        ...
        let operation = PackedUserOperation {
            ...
            paymaster: Some("0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef"
                    .parse()
                    .unwrap()),
            paymaster_verification_gas_limit: Some(U256::from(100000)),
            paymaster_post_op_gas_limit: Some(U256::from(100000)),
            paymaster_data: Some("0x0000000000000000000000000000000000000000080085".parse().unwrap()),
