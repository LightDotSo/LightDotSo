...
lazy_static! {
    pub static ref TRANSFER_EVENT_TOPIC: B256 =
...
lazy_static! {
    pub static ref TRANSFER_SINGLE_EVENT_TOPIC: B256 =
        ...
        B256::from_str("0xc3d58168c5ae7397731d063d5bbf3d657854427343f4c083240f7aacaa2d0f62")
            .expect("Failed to parse address");
}

lazy_static! {
    pub static ref TRANSFER_BATCH_EVENT_TOPIC: B256 =
        ...
        B256::from_str("0x4a39dc06d4c0dbc64b70af90fd698a233a518aa5d07e595d983b8c0526c8f7fb")
            .expect("Failed to parse address");
}
