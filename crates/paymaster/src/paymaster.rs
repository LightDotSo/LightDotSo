...
pub fn get_pack(user_operation: UserOperationConstruct) -> Token {
    ...
    Token::Bytes(encode(&[
        ...
        Token::Uint(
            // 0x1a0 = 416
            (416 + (((if user_operation.init_code.is_empty() || user_operation.call_data.is_empty()
            {
                31
            } else {
                62
            } + user_operation.init_code.len() +
                user_operation.call_data.len()) /
                32) *
                32))
            .into(),
        ),
        Token::Uint(
            // 0x260 = 608
            (608 + (((if user_operation.init_code.is_empty() || user_operation.call_data.is_empty()
            {
                31
            } else {
                62
...
mod tests {
    ...
    fn test_get_pack_long() {
        let user_operation = UserOperationConstruct {
            sender: "0xF46D20dC61A5f43773Ad172602647f194a69a16d".parse().unwrap(),
            nonce: U256::from(0),
            init_code: "".parse().unwrap(),
            call_data: "0000000000756d3e6464f5efe7e413a0af1c7474183815c83c01efabf2ce62868626005b468fcc0cd03c644030e51dad0d5df74b0fbd4e950000000000000000000000000000000000000000000000000000018b838a0758".parse().unwrap(),
            call_gas_limit: U256::from(4514240),
            verification_gas_limit: U256::from(1854272),
            pre_verification_gas: U256::from(1854272),
            max_fee_per_gas: U256::from(56674171701_i64),
...
// callData
// 
...
// long
// 
