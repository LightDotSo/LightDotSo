...
pub fn get_pack(user_operation: UserOperationConstruct) -> Token {
    ...
    // 0x1a0 = 416
    let offset =
        416 + (((user_operation.init_code.len() + user_operation.call_data.len()) / 32) * 32);
    ...
    // Get the length.
    // 0x260 = 608
    let length = 608 + user_operation.init_code.len() + user_operation.call_data.len();
...
// pack
// init_code: 88 -> 88/32 = 2..24
// call_data: 132 -> 132/32 = 4..0
// offset: 42: 0x2a -> +16
// length: 54: 0x36 -> +16
...
// long
// init_code: 176 -> 176/32 = 5..16
// call_data: 88 -> 88/32 = 3..24
// offset: 44: 0x2c -> +18
// length: 56: 0x38 -> +18
