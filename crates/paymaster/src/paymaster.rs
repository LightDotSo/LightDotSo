...
pub fn get_pack(user_operation: UserOperationConstruct) -> Token {
    Token::Bytes(encode(&[
        ...
        Token::Uint(
            // 0x1a0 = 416
            (416 + (cmp::max(user_operation.init_code.len() + user_operation.call_data.len(), 32) /
                32 *
                32))
            .into(),
        ),
        Token::Uint(
            // 0x260 = 608
            (608 + (cmp::max(user_operation.init_code.len() + user_operation.call_data.len(), 32) /
                32 *
                32))
            .into(),
        ),
...
mod tests {
    ...
    fn test_get_pack() {
        ...
        assert_eq!(
            ...
            "0x2241dc536885a911469c115a04528f8ede50a0c622a961593f5da650cc666c9d"
        )
    }
...
// pack
// 
...
// raw
// 
