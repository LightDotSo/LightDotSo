...
lazy_static! {
    pub static ref NODE_1: SignerNode = SignerNode {
        ...
        signer: Some(Signer {
            ...
            leaf: SignatureLeaf::ECDSASignature(ECDSASignatureLeaf {
                address: Address::from_str("0x6a202a0ba513f87db9174e44300378b25f1950bb").unwrap(),
    ...
    pub static ref NODE_2: SignerNode = SignerNode {
    ...
    pub static ref TREES: Vec<&'static SignerNode> = vec![&NODE_1, &NODE_2];
}
...
async fn test_integration_signatures() {
    for (i, signature) in SIGNATURES.iter().enumerate() {
        ...
        assert_eq!(recovered.tree, TREES[i].clone());
    }
}
