...
export const LATEST_ENTRYPOINT_ADDRESS: Address =
  CONTRACT_ADDRESSES[ContractAddress.ENTRYPOINT_V070_ADDRESS];

export const LATEST_WALLET_FACTORY_ADDRESS: Address =
  CONTRACT_ADDRESSES[ContractAddress.LIGHT_WALLET_FACTORY_V030_ADDRESS];

export const LATEST_WALLET_FACTORY_IMPLEMENTATION_ADDRESS: Address =
...
export const LATEST_CONTRACT_ADDRESSES: {
  ...
  [LatestContractAddress.ENTRYPOINT_ADDRESS]: LATEST_ENTRYPOINT_ADDRESS,
