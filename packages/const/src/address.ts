...
export enum ContractAddress {
  ...
  LIGHT_WALLET_FACTORY_IMPLEMENTATION = "Light Wallet Factory Implementation",
}
...
export const CONTRACT_ADDRESSES: {
  ...
  [ContractAddress.LIGHT_WALLET_FACTORY_ADDRESS]:
    "0x000000000048C2e27c97B9978c9B27f6937A40db",
  ...
  [ContractAddress.LIGHT_WALLET_FACTORY_IMPLEMENTATION]:
    "0x5d02B6345898b193B66CA89E7A693CC11DC72954",
...
console.assert(
  CONTRACT_ADDRESSES[ContractAddress.ENTRYPOINT_ADDRESS] ===
    CONTRACT_ADDRESSES[ContractAddress.ENTRYPOINT_V070_ADDRESS],
);

// biome-ignore lint/suspicious/noConsole: <explanation>
console.assert(
  CONTRACT_ADDRESSES[ContractAddress.LIGHT_WALLET_FACTORY_ADDRESS] ===
    CONTRACT_ADDRESSES[ContractAddress.LIGHT_WALLET_FACTORY_V030_ADDRESS],
);

// biome-ignore lint/suspicious/noConsole: <explanation>
console.assert(
  CONTRACT_ADDRESSES[ContractAddress.LIGHT_WALLET_FACTORY_IMPLEMENTATION] ===
    CONTRACT_ADDRESSES[
      ContractAddress.LIGHT_WALLET_FACTORY_V030_IMPLEMENTATION
    ],
);
