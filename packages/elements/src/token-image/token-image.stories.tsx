...
export const Base: Story = {
  render: (_args) => <TokenImage token={tokenGetData} />,
  args: {},
};
export const isLoading: Story = {
  render: (_args) => <TokenImage isLoading token={tokenGetData} />,
  args: {},
};
...
export const WithChainLogo: Story = {
  render: (_args) => <TokenImage withChainLogo token={tokenGetData} />,
  args: {},
};
...
export const WithChainLogoIsLoading: Story = {
  render: (_args) => (
    <TokenImage withChainLogo isLoading token={tokenGetData} />
  ),
  args: {},
};
