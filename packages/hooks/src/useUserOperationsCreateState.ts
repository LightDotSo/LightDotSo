...
export const useUserOperationsCreateState = () => {
  ...
  const userOperationsCreateStateLoading = useMemo(() => {
    return (
  ...
  const userOperationsCreateStateSuccess = useMemo(() => {
    return (
  ...
  const userOperationsCreateStateError = useMemo(() => {
    return (
  ...
  return {
    userOperationsCreateStateLoading: userOperationsCreateStateLoading,
    userOperationsCreateStateSuccess: userOperationsCreateStateSuccess,
    userOperationsCreateStateError: userOperationsCreateStateError,
  };
};
