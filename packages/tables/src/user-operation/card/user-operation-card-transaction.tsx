    ...
    <Collapsible key={userOperation.hash} asChild>
      <>
        <CollapsibleTrigger
          ...
          type={undefined}
        >
          <div className="group transaction flex w-full items-center border-b border-b-border p-3 transition-colors last:border-b-0 hover:bg-background-stronger/50">
