...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 font-semibold text-sm text-text",
      inset && "pl-8",
      className,
    )}
    {...props}
