...
export const H1Story: Story = {
  name: "H1",
  render: (_args) => <H1>Taxing Laughter: The Joke Tax Chronicles</H1>,
  args: {},
};

export const H2Story: Story = {
  name: "H2",
  render: (_args) => <H2>Taxing Laughter: The Joke Tax Chronicles</H2>,
  args: {},
};

export const H3Story: Story = {
  name: "H3",
  render: (_args) => <H3>Taxing Laughter: The Joke Tax Chronicles</H3>,
  args: {},
};

export const H4Story: Story = {
  name: "H4",
  render: (_args) => <H4>Taxing Laughter: The Joke Tax Chronicles</H4>,
  args: {},
};

export const PStory: Story = {
  name: "P",
  render: (_args) => <P>Taxing Laughter: The Joke Tax Chronicles</P>,
  args: {},
};
...
export const LeadStory: Story = {
  name: "Lead",
  render: (_args) => <Lead>Taxing Laughter: The Joke Tax Chronicles</Lead>,
  args: {},
};

export const LargeStory: Story = {
  name: "Large",
  render: (_args) => <Large>Taxing Laughter: The Joke Tax Chronicles</Large>,
  args: {},
};

export const SmallStory: Story = {
  name: "Small",
  render: (_args) => <Small>Taxing Laughter: The Joke Tax Chronicles</Small>,
  args: {},
};

export const SubtleStory: Story = {
  name: "Subtle",
  render: (_args) => <Subtle>Taxing Laughter: The Joke Tax Chronicles</Subtle>,
  args: {},
};
